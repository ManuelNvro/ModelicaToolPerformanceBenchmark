...
extern "C" {
#endif
int OpenIPSL_IEEE14_IEEE_14_Buses_mayer(DATA* data, modelica_real** res,short *i) {
...
int OpenIPSL_IEEE14_IEEE_14_Buses_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
}
